...
class PagesController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Requests\StorePageRequest $request, $id)
    {
        $this->pages->create($request->only('title', 'uri', 'name', 'content','templates', 'hidden'));
    ...
    public function update(Requests\UpdatePageRequest $request, $id)
    {
        ...
        $page->fill($request->only('title', 'uri', 'name', 'content', 'templates', 'hidden'))->save();
